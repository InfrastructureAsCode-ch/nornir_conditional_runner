...
![Coverage Status](https://img.shields.io/github/actions/workflow/status/InfrastructureAsCode.ch/nornir_conditional_runner/.github/workflows/main.yaml?label=Tests&style=flat-square)
